...
private:
  ...
  void downsample(const PointCloud::Ptr & input_cloud_ptr, PointCloud::Ptr & output_cloud_ptr);
  void crop(const PointCloud::Ptr & input_cloud_ptr, PointCloud::Ptr & output_cloud_ptr);
  ...
  std::optional<sensor_msgs::msg::Imu> imu_data_;
  ...
  std::optional<rclcpp::Time> previous_scan_time_;
